...
API.get('/', function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var querySnapshot, orders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.db.collection('Orders').get()];
            case 1:
                querySnapshot = _a.sent();
                orders = querySnapshot.docs.map(function (o) { return (__assign({ id: o.id }, o.data())); });
                res.send(orders);
                return [2 /*return*/];
        }
    });
